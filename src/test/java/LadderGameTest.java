...
public class LadderGameTest {
  ...
  void with_ValidInput_ValidOutput() {
    ...
    // when
    LadderGame ladderGame = LadderGame.with(ladderGameInputData, rowGeneratorStrategy);
    // then
  ...
  void generateLadder_ManualStrategy_ValidLadder() {
    ...
    LadderGameInputData ladderGameInputData = LadderGameInputDataTest.getLadderInputDataFixture(userNames, height, prizeNames);
    RowGeneratorStrategy rowGeneratorStrategy = new RowWithEvenIndexLinesGeneratorStrategy();
    LadderGame ladderGame = LadderGame.with(ladderGameInputData, rowGeneratorStrategy);
    // when
